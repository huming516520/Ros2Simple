...
#ifndef DATA__MSG__DETAIL__TEST__STRUCT_HPP_
#define DATA__MSG__DETAIL__TEST__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__data__msg__Test __attribute__((deprecated))
#else
# define DEPRECATED__data__msg__Test __declspec(deprecated)
#endif
...
struct Test_
{
  ...
  // pointer types
  using RawPtr =
    test_msgs::msg::Test_<ContainerAllocator> *;
  using ConstRawPtr =
    const test_msgs::msg::Test_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<test_msgs::msg::Test_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<test_msgs::msg::Test_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      test_msgs::msg::Test_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<test_msgs::msg::Test_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<test_msgs::msg::Test_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<test_msgs::msg::Test_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<test_msgs::msg::Test_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__data__msg__Test
    std::shared_ptr<test_msgs::msg::Test_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__data__msg__Test
    std::shared_ptr<test_msgs::msg::Test_<ContainerAllocator> const>
...
using Test =
  test_msgs::msg::Test_<std::allocator<void>>;
...
#endif  // DATA__MSG__DETAIL__TEST__STRUCT_HPP_
